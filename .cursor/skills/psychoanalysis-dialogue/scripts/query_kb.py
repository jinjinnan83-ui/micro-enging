#!/usr/bin/env python3
"""Retrieve psychoanalysis knowledge-base passages for dialogue.
...
Usage (from project root or anywhere):
  python .cursor/skills/psychoanalysis-dialogue/scripts/query_kb.py "我总是梦见被关起来"
  python query_kb.py "投射性认同" --school 客体关系 --top-n 5
  python query_kb.py "镜像" --hybrid
"""
...
def bm25_search(
    ...
    *,
    ...
    tokenized = [tokenize_psychoanalytic(row.get("text", "")) for row in filtered]
    bm25 = BM25Okapi(tokenized)
    tokens = expand_query_tokens(tokenize_psychoanalytic(query))
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Query the psychoanalysis knowledge base.")
    parser.add_argument("query", help="用户原话，或改写成的理论检索句")
    parser.add_argument("--top-n", type=int, default=5)
    parser.add_argument("--school", default=None, help="精神分析 / 拉康派 / 客体关系 / 分析心理学 / 自体心理学 / 关系精神分析 / 个体心理学 / 心智化")
